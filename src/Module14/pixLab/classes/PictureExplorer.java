package Module14.pixLab.classes;/*
 * Purpose:
 * 
 * < your name >
 * < today's date >
...
import Module14.pixLab.classes.Picture;
...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener
{
  ...
  {
    Picture pix = new Picture("src/Module14/pixLab/images/CumberlandIsland.jpg");
    Picture small = pix.scale(0.75, 0.75);

    pix.write("SmallIsland.jpg");
    pix.explore();
