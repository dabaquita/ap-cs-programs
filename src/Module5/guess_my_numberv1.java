...
public class guess_my_numberv1
{
    public static void main(String[] args)
    {
        ...
        while( userGuessNum != secretNumber && userGuessNum >= lowerLimit && userGuessNum <= upperLimit)
        {
            //Since the guess doesn't match, determine if it is too low or too high.
            if (userGuessNum < secretNumber)
            {
                System.out.print("Guess number " + userGuessNum + " is too LOW. ");
            }
            else if (userGuessNum > secretNumber)
            {
                System.out.print("Guess number " + userGuessNum + " is too HIGH. ");
            }
