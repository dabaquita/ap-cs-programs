...
public class Magpie2
{
    ...
    public String getResponse(String statement)
    {
        ...
        else if (statement.indexOf("Mrs. Shusterman") >= 0)
        {
            response = "She sounds like a great teacher!";
        }
        else if (statement.trim().length() < 0)         // checks for lack of response
        {
        ...
        {
            response = "What do you like to do for fun?";
        }
        else if (statement.indexOf("scary") >= 0)
        {
            response = "Do you know what's scary? Clowns.";
        }
        else
        {
